CREATE USER 'onlinebank_development'@'%' IDENTIFIED BY 'oPItyPticIAt';
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES on *.* TO 'onlinebank_development'@'%';
FLUSH PRIVILEGES;
